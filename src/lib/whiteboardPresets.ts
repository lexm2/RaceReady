...
export const PRESETS: WhiteboardPreset[] = [
  ...
  },
  {
    ...
    hint: 'Press play. Boat B starts clear astern, then passes Boat A. Watch for the Rule 15 card on B as the keep-clear flips.',
    scene: {
      ...baseScene,
      boats: [
        A({ position: { x: 140, y: 100 }, heading: 315, tack: 'starboard' }),
        B({ position: { x: 165, y: 110 }, heading: 315, tack: 'starboard', speed: 7 }),
      ],
      waypoints: [
        wp('wp-r15-a-1', 'boat-a', 110, 70, 0),
        wp('wp-r15-b-1', 'boat-b', 120, 80, 0),
      ],
    },
    autoPlay: true,
  },
  {
    ...
    hint: 'Press play. Boat A (starboard, ROW) makes a sharp turn. Rule 16 fires on A while it turns.',
    scene: {
      ...baseScene,
      boats: [
        A({ position: { x: 160, y: 160 }, heading: 315, tack: 'starboard' }),
        B({ position: { x: 170, y: 150 }, heading: 45,  tack: 'port' }),
      ],
      waypoints: [
        wp('wp-r16-a-1', 'boat-a', 180, 100, 0),
        wp('wp-r16-b-1', 'boat-b', 210, 110, 0),
      ],
    },
    autoPlay: true,
  },
  {
    ...
    hint: 'Both starboard, overlapped. Boat B (leeward) is heading above close-hauled — Rule 17 advisory fires on B alongside Rule 11 on A.',
    scene: {
      ...baseScene,
      boats: [
        A({ position: { x: 160, y: 100 }, heading: 315, tack: 'starboard' }),
        B({ position: { x: 155, y: 110 }, heading: 350, tack: 'starboard' }),
      ],
      waypoints: [],
    },
  },
